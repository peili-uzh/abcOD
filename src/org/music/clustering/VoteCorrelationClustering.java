...
public class VoteCorrelationClustering extends AbstractCorrelationClustering {

    public VoteCorrelationClustering(ArrayList records,
    ...
    public static void process() {
        ...
        while (para <= 20) {
            ...
            Evaluation evaluation = new Evaluation();
            System.out.println(para + "-----------final VOTE correlation cluster quality -------------");
    ...
    private static double computeClusterCost(int id1, int cluster2) {
        ...
        for (int i = 0; i < clusters.get(cluster2).getEntities().size(); i++) {
            ...
            quality += cost;
            //System.out.println("\t\t\t"+id1+"\t"+id2+"\t"+"\t"+cost+"\t"+quality);
